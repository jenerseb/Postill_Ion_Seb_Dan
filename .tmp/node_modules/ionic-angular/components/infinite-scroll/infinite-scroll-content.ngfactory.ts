...
function viewFactory_InfiniteScrollContent_Host0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<any> {
  if ((renderType_InfiniteScrollContent_Host === (null as any))) { (renderType_InfiniteScrollContent_Host = viewUtils.createRenderComponentType('',0,import10.ViewEncapsulation.None,[],{})); }
...
export function viewFactory_InfiniteScrollContent0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.InfiniteScrollContent> {
  if ((renderType_InfiniteScrollContent === (null as any))) { (renderType_InfiniteScrollContent = viewUtils.createRenderComponentType('D:/_WebProjects/_Detzler_App_Postillion_RSS/blank-rss-postillon-ionic2/node_modules/ionic-angular/components/infinite-scroll/infinite-scroll-content.d.ts class InfiniteScrollContent - inline template',0,import10.ViewEncapsulation.None,styles_InfiniteScrollContent,{})); }
