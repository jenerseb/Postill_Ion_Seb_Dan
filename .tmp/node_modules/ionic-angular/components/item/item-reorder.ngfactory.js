...
var _View_Reorder_Host0 = (function (_super) {
    ...
    function _View_Reorder_Host0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_Reorder_Host0, renderType_Reorder_Host, import6.ViewType.HOST, viewUtils, parentInjector, declarationEl, import7.ChangeDetectorStatus.CheckAlways);
    }
    ...
    _View_Reorder_Host0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import3.Reorder) && (0 === requestNodeIndex))) {
...
function viewFactory_Reorder_Host0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_Reorder_Host === null)) {
        (renderType_Reorder_Host = viewUtils.createRenderComponentType('', 0, import10.ViewEncapsulation.None, [], {}));
    }
    return new _View_Reorder_Host0(viewUtils, parentInjector, declarationEl);
}
export var ReorderNgFactory = new import11.ComponentFactory('ion-reorder', viewFactory_Reorder_Host0, import3.Reorder);
var styles_Reorder = [];
...
var _View_Reorder0 = (function (_super) {
    ...
    function _View_Reorder0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_Reorder0, renderType_Reorder, import6.ViewType.COMPONENT, viewUtils, parentInjector, declarationEl, import7.ChangeDetectorStatus.CheckAlways);
    }
...
export function viewFactory_Reorder0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_Reorder === null)) {
        (renderType_Reorder = viewUtils.createRenderComponentType('D:/_WebProjects/_Detzler_App_Postillion_RSS/blank-rss-postillon-ionic2/node_modules/ionic-angular/components/item/item-reorder.d.ts class Reorder - inline template', 0, import10.ViewEncapsulation.None, styles_Reorder, {}));
    }
