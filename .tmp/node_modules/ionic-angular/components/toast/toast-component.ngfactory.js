...
export function viewFactory_ToastCmp0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_ToastCmp === null)) {
        (renderType_ToastCmp = viewUtils.createRenderComponentType('D:/_WebProjects/_Detzler_App_Postillion_RSS/blank-rss-postillon-ionic2/node_modules/ionic-angular/components/toast/toast-component.d.ts class ToastCmp - inline template', 0, import12.ViewEncapsulation.None, styles_ToastCmp, {}));
    }
