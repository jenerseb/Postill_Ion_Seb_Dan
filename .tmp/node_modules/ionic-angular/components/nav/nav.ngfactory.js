...
var _View_Nav_Host0 = (function (_super) {
    ...
    function _View_Nav_Host0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_Nav_Host0, renderType_Nav_Host, import6.ViewType.HOST, viewUtils, parentInjector, declarationEl, import7.ChangeDetectorStatus.CheckAlways);
    }
    ...
    _View_Nav_Host0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import3.Nav) && (0 === requestNodeIndex))) {
...
export var NavNgFactory = new import20.ComponentFactory('ion-nav', viewFactory_Nav_Host0, import3.Nav);
var styles_Nav = [];
...
var _View_Nav0 = (function (_super) {
    ...
    function _View_Nav0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_Nav0, renderType_Nav, import6.ViewType.COMPONENT, viewUtils, parentInjector, declarationEl, import7.ChangeDetectorStatus.CheckAlways);
    }
...
export function viewFactory_Nav0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_Nav === null)) {
        (renderType_Nav = viewUtils.createRenderComponentType('D:/_WebProjects/_Detzler_App_Postillion_RSS/blank-rss-postillon-ionic2/node_modules/ionic-angular/components/nav/nav.d.ts class Nav - inline template', 0, import19.ViewEncapsulation.None, styles_Nav, {}));
    }
