...
function viewFactory_Img_Host0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<any> {
  if ((renderType_Img_Host === (null as any))) { (renderType_Img_Host = viewUtils.createRenderComponentType('',0,import12.ViewEncapsulation.None,[],{})); }
...
export function viewFactory_Img0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.Img> {
  if ((renderType_Img === (null as any))) { (renderType_Img = viewUtils.createRenderComponentType('D:/_WebProjects/_Detzler_App_Postillion_RSS/blank-rss-postillon-ionic2/node_modules/ionic-angular/components/img/img.d.ts class Img - inline template',0,import12.ViewEncapsulation.None,styles_Img,{})); }
