...
function viewFactory_Button_Host0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<any> {
  if ((renderType_Button_Host === (null as any))) { (renderType_Button_Host = viewUtils.createRenderComponentType('',0,import10.ViewEncapsulation.None,[],{})); }
...
export function viewFactory_Button0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.Button> {
  if ((renderType_Button === (null as any))) { (renderType_Button = viewUtils.createRenderComponentType('D:/_WebProjects/_Detzler_App_Postillion_RSS/blank-rss-postillon-ionic2/node_modules/ionic-angular/components/button/button.d.ts class Button - inline template',1,import10.ViewEncapsulation.None,styles_Button,{})); }
