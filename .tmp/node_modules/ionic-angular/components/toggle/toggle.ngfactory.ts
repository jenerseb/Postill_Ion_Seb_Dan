...
var renderType_Toggle_Host:import0.RenderComponentType = (null as any);
class _View_Toggle_Host0 extends import1.AppView<any> {
  ...
  get _NG_VALUE_ACCESSOR_0_5():any[] {
    if ((this.__NG_VALUE_ACCESSOR_0_5 == (null as any))) { (this.__NG_VALUE_ACCESSOR_0_5 = [this._Toggle_0_4]); }
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._Toggle_0_4 = new import3.Toggle(this.parentInjector.get(import8.Form),this.parentInjector.get(import9.Config),new import10.ElementRef(this._el_0),this.renderer,this.parentInjector.get(import11.Haptic),this.parentInjector.get(import12.Item,(null as any)));
    this._appEl_0.initComponent(this._Toggle_0_4,[],compView_0);
    compView_0.create(this._Toggle_0_4,this.projectableNodes,(null as any));
...
function viewFactory_Toggle_Host0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<any> {
  if ((renderType_Toggle_Host === (null as any))) { (renderType_Toggle_Host = viewUtils.createRenderComponentType('',0,import14.ViewEncapsulation.None,[],{})); }
  return new _View_Toggle_Host0(viewUtils,parentInjector,declarationEl);
}
export const ToggleNgFactory:import15.ComponentFactory<import3.Toggle> = new import15.ComponentFactory<import3.Toggle>('ion-toggle',viewFactory_Toggle_Host0,import3.Toggle);
const styles_Toggle:any[] = [];
var renderType_Toggle:import0.RenderComponentType = (null as any);
...
export function viewFactory_Toggle0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.Toggle> {
  if ((renderType_Toggle === (null as any))) { (renderType_Toggle = viewUtils.createRenderComponentType('D:/_WebProjects/_Detzler_App_Postillion_RSS/blank-rss-postillon-ionic2/node_modules/ionic-angular/components/toggle/toggle.d.ts class Toggle - inline template',0,import14.ViewEncapsulation.None,styles_Toggle,{})); }
