...
var renderType_Toolbar_Host:import0.RenderComponentType = (null as any);
class _View_Toolbar_Host0 extends import1.AppView<any> {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._Toolbar_0_4 = new import3.Toolbar(this.parentInjector.get(import8.ViewController,(null as any)),this.parentInjector.get(import9.Config),new import10.ElementRef(this._el_0),this.renderer);
...
function viewFactory_Toolbar_Host0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<any> {
  if ((renderType_Toolbar_Host === (null as any))) { (renderType_Toolbar_Host = viewUtils.createRenderComponentType('',0,import11.ViewEncapsulation.None,[],{})); }
  return new _View_Toolbar_Host0(viewUtils,parentInjector,declarationEl);
}
export const ToolbarNgFactory:import12.ComponentFactory<import3.Toolbar> = new import12.ComponentFactory<import3.Toolbar>('ion-toolbar',viewFactory_Toolbar_Host0,import3.Toolbar);
const styles_Toolbar:any[] = [];
var renderType_Toolbar:import0.RenderComponentType = (null as any);
class _View_Toolbar0 extends import1.AppView<import3.Toolbar> {
  _el_0:any;
  _NgClass_0_3:import13.NgClass;
  _el_1:any;
  _NgClass_1_3:import13.NgClass;
  /*private*/ _expr_0:any;
  /*private*/ _expr_1:any;
  /*private*/ _expr_2:any;
  /*private*/ _expr_3:any;
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import13.NgClass) && (0 === requestNodeIndex))) { return this._NgClass_0_3; }
    if (((token === import13.NgClass) && (1 === requestNodeIndex))) { return this._NgClass_1_3; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
...
export function viewFactory_Toolbar0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.Toolbar> {
  if ((renderType_Toolbar === (null as any))) { (renderType_Toolbar = viewUtils.createRenderComponentType('D:/_WebProjects/_Detzler_App_Postillion_RSS/blank-rss-postillon-ionic2/node_modules/ionic-angular/components/toolbar/toolbar.d.ts class Toolbar - inline template',4,import11.ViewEncapsulation.None,styles_Toolbar,{})); }
