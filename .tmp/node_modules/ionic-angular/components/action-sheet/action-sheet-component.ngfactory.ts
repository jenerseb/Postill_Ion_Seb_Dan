...
var renderType_ActionSheetCmp_Host:import0.RenderComponentType = (null as any);
class _View_ActionSheetCmp_Host0 extends import1.AppView<any> {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    this._el_0 = this.selectOrCreateHostElement('ion-action-sheet',rootSelector,(null as any));
    ...
    compView_0.create(this._ActionSheetCmp_0_4,this.projectableNodes,(null as any));
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    if (import4.checkBinding(throwOnChange,this._expr_2,currVal_2)) {
      this.renderer.setElementAttribute(this._el_0,'aria-describedby',((currVal_2 == (null as any))? (null as any): currVal_2.toString()));
...
function viewFactory_ActionSheetCmp_Host0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<any> {
  if ((renderType_ActionSheetCmp_Host === (null as any))) { (renderType_ActionSheetCmp_Host = viewUtils.createRenderComponentType('',0,import13.ViewEncapsulation.None,[],{})); }
  return new _View_ActionSheetCmp_Host0(viewUtils,parentInjector,declarationEl);
}
export const ActionSheetCmpNgFactory:import14.ComponentFactory<import3.ActionSheetCmp> = new import14.ComponentFactory<import3.ActionSheetCmp>('ion-action-sheet',viewFactory_ActionSheetCmp_Host0,import3.ActionSheetCmp);
const styles_ActionSheetCmp:any[] = [];
var renderType_ActionSheetCmp:import0.RenderComponentType = (null as any);
class _View_ActionSheetCmp0 extends import1.AppView<import3.ActionSheetCmp> {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._el_3 = this.renderer.createElement(this._el_2,'div',(null as any));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import16.NgIf) && (5 === requestNodeIndex))) { return this._NgIf_5_6; }
    if (((token === import19.TemplateRef) && (6 === requestNodeIndex))) { return this._TemplateRef_6_5; }
    if (((token === import17.NgFor) && (6 === requestNodeIndex))) { return this._NgFor_6_6; }
    if (((token === import19.TemplateRef) && (7 === requestNodeIndex))) { return this._TemplateRef_7_5; }
    if (((token === import16.NgIf) && (7 === requestNodeIndex))) { return this._NgIf_7_6; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
...
class _View_ActionSheetCmp3 extends import1.AppView<any> {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._Button_0_5 = new import22.Button((null as any),'action-sheet-button',this.parent.parentInjector.get(import9.Config),new import10.ElementRef(this._el_0),this.renderer);
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    const currVal_2:any = 'disable-hover';
    if (import4.checkBinding(throwOnChange,this._expr_2,currVal_2)) {
      this._NgClass_0_4.klass = currVal_2;
      this._expr_2 = currVal_2;
    }
    const currVal_3:any = this.context.$implicit.cssClass;
    if (import4.checkBinding(throwOnChange,this._expr_3,currVal_3)) {
      this._NgClass_0_4.ngClass = currVal_3;
      this._expr_3 = currVal_3;
    }
    if (!throwOnChange) { this._NgClass_0_4.ngDoCheck(); }
    const currVal_4:any = this.context.$implicit.icon;
    if (import4.checkBinding(throwOnChange,this._expr_4,currVal_4)) {
      this._NgIf_1_6.ngIf = currVal_4;
      this._expr_4 = currVal_4;
    }
    this.detectContentChildrenChanges(throwOnChange);
    if (!throwOnChange) { if ((this.numberOfChecks === 0)) { this._Button_0_5.ngAfterContentInit(); } }
    const currVal_1:any = (this.context.$implicit.icon? '': (null as any));
    if (import4.checkBinding(throwOnChange,this._expr_1,currVal_1)) {
      this.renderer.setElementAttribute(this._el_0,'icon-left',((currVal_1 == (null as any))? (null as any): currVal_1.toString()));
      this._expr_1 = currVal_1;
    }
    const currVal_5:any = import4.interpolate(1,'',this.context.$implicit.text,'');
...
class _View_ActionSheetCmp5 extends import1.AppView<any> {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._Button_1_5 = new import22.Button((null as any),'action-sheet-button',this.parent.parentInjector.get(import9.Config),new import10.ElementRef(this._el_1),this.renderer);
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    const currVal_2:any = 'action-sheet-cancel disable-hover';
    if (import4.checkBinding(throwOnChange,this._expr_2,currVal_2)) {
      this._NgClass_1_4.klass = currVal_2;
      this._expr_2 = currVal_2;
    }
    const currVal_3:any = this.parent.context.d.cancelButton.cssClass;
    if (import4.checkBinding(throwOnChange,this._expr_3,currVal_3)) {
      this._NgClass_1_4.ngClass = currVal_3;
      this._expr_3 = currVal_3;
    }
    if (!throwOnChange) { this._NgClass_1_4.ngDoCheck(); }
    const currVal_4:any = this.parent.context.d.cancelButton.icon;
    if (import4.checkBinding(throwOnChange,this._expr_4,currVal_4)) {
      this._NgIf_2_6.ngIf = currVal_4;
      this._expr_4 = currVal_4;
    }
    this.detectContentChildrenChanges(throwOnChange);
    if (!throwOnChange) { if ((this.numberOfChecks === 0)) { this._Button_1_5.ngAfterContentInit(); } }
    const currVal_1:any = (this.parent.context.d.cancelButton.icon? '': (null as any));
    if (import4.checkBinding(throwOnChange,this._expr_1,currVal_1)) {
      this.renderer.setElementAttribute(this._el_1,'icon-left',((currVal_1 == (null as any))? (null as any): currVal_1.toString()));
      this._expr_1 = currVal_1;
    }
    const currVal_5:any = import4.interpolate(1,'',this.parent.context.d.cancelButton.text,'');
    if (import4.checkBinding(throwOnChange,this._expr_5,currVal_5)) {
