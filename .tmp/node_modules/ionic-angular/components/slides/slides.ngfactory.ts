...
function viewFactory_Slides_Host0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<any> {
  if ((renderType_Slides_Host === (null as any))) { (renderType_Slides_Host = viewUtils.createRenderComponentType('',0,import10.ViewEncapsulation.None,[],{})); }
...
export function viewFactory_Slides0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.Slides> {
  if ((renderType_Slides === (null as any))) { (renderType_Slides = viewUtils.createRenderComponentType('D:/_WebProjects/_Detzler_App_Postillion_RSS/blank-rss-postillon-ionic2/node_modules/ionic-angular/components/slides/slides.d.ts class Slides - inline template',1,import10.ViewEncapsulation.None,styles_Slides,{})); }
...
function viewFactory_Slide_Host0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<any> {
  if ((renderType_Slide_Host === (null as any))) { (renderType_Slide_Host = viewUtils.createRenderComponentType('',0,import10.ViewEncapsulation.None,[],{})); }
...
export function viewFactory_Slide0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.Slide> {
  if ((renderType_Slide === (null as any))) { (renderType_Slide = viewUtils.createRenderComponentType('D:/_WebProjects/_Detzler_App_Postillion_RSS/blank-rss-postillon-ionic2/node_modules/ionic-angular/components/slides/slides.d.ts class Slide - inline template',1,import10.ViewEncapsulation.None,styles_Slide,{})); }
