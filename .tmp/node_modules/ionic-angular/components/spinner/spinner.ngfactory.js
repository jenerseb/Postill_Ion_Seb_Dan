...
export function viewFactory_Spinner0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_Spinner === null)) {
        (renderType_Spinner = viewUtils.createRenderComponentType('D:/_WebProjects/_Detzler_App_Postillion_RSS/blank-rss-postillon-ionic2/node_modules/ionic-angular/components/spinner/spinner.d.ts class Spinner - inline template', 0, import10.ViewEncapsulation.None, styles_Spinner, {}));
    }
