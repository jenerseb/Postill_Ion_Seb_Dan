...
var _View_IonicApp_Host0 = (function (_super) {
    ...
    _View_IonicApp_Host0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import3.IonicApp) && (0 === requestNodeIndex))) {
...
export var IonicAppNgFactory = new import14.ComponentFactory('ion-app', viewFactory_IonicApp_Host0, import3.IonicApp);
var styles_IonicApp = [];
...
var _View_IonicApp0 = (function (_super) {
    ...
    _View_IonicApp0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import16.OverlayPortal) && (1 === requestNodeIndex))) {
            return this._OverlayPortal_1_5;
        }
        if (((token === import16.OverlayPortal) && (2 === requestNodeIndex))) {
            return this._OverlayPortal_2_5;
        }
        if (((token === import16.OverlayPortal) && (3 === requestNodeIndex))) {
            return this._OverlayPortal_3_5;
        }
        if (((token === import16.OverlayPortal) && (4 === requestNodeIndex))) {
...
export function viewFactory_IonicApp0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_IonicApp === null)) {
        (renderType_IonicApp = viewUtils.createRenderComponentType('D:/_WebProjects/_Detzler_App_Postillion_RSS/blank-rss-postillon-ionic2/node_modules/ionic-angular/components/app/app-root.d.ts class IonicApp - inline template', 0, import13.ViewEncapsulation.None, styles_IonicApp, {}));
    }
